...
router.register("ItemProducto",views.ItemProductoApi, basename="ItemProducto")
...
router.register("ItemProducto2",views.ItemProductoApiDepth, basename="ItemProducto2")
